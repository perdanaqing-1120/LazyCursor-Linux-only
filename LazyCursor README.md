...
Shortcut
	Action
	Ctrl + M
	Toggle LazyCursor Mode (Active/Inactive)
	Arrow Keys
	Move cursor
	Shift + Arrow
	Move slower (-5 speed)
	...
	Scroll Down
	Ctrl + Up
	Increase base sensitivity
	Ctrl + Down
	Decrease base sensitivity
	Ctrl + H
	Open help terminal (View all shortcuts)
	🛠️ Prerequisites
...
git clone [https://github.com/YOUR_USERNAME/LazyCursor.git](https://github.com/YOUR_USERNAME/LazyCursor.git)
cd LazyCursor
python3 -m venv .venv
